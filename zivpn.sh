...
menu() {
    ...
    echo -e "7.  Top IP (Traffic)"
    echo -e "8.  Backup to Telegram"
    echo -e "9.  Restore Data"
    echo -e "10. Install / Re-Install ZIVPN"
    echo -e "11. Uninstall ZIVPN"
    echo -e "12. Update Script"
    echo -e "13. Set Auto-Backup Time"
    echo -e "14. Set/Change Domain"
    echo -e "15. Install API Service"
    echo -e "16. Exit"
    echo -e "${BLUE}=========================================${NC}"
